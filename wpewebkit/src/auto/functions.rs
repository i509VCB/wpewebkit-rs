...
pub fn uri_for_display(uri: &str) -> Option<glib::GString> {
    ...
    unsafe {
        from_glib_full(ffi::webkit_uri_for_display(uri.to_glib_none().0))
    }
}
...
pub fn user_media_permission_is_for_audio_device(request: &impl IsA<UserMediaPermissionRequest>) -> bool {
    skip_assert_initialized!();
    unsafe {
        from_glib(ffi::webkit_user_media_permission_is_for_audio_device(request.as_ref().to_glib_none().0))
    }
}
...
pub fn user_media_permission_is_for_display_device(request: &impl IsA<UserMediaPermissionRequest>) -> bool {
    skip_assert_initialized!();
    unsafe {
        from_glib(ffi::webkit_user_media_permission_is_for_display_device(request.as_ref().to_glib_none().0))
    }
}
...
pub fn user_media_permission_is_for_video_device(request: &impl IsA<UserMediaPermissionRequest>) -> bool {
    skip_assert_initialized!();
    unsafe {
        from_glib(ffi::webkit_user_media_permission_is_for_video_device(request.as_ref().to_glib_none().0))
    }
}
