...
const RUST_LAYOUTS: &[(&str, Layout)] = &[
    ...
    (
        ...
        Layout {
            size: size_of::<SoupServerMessageClass>(),
    ...
    (
        "SoupSessionError",
        Layout {
            size: size_of::<SoupSessionError>(),
            alignment: align_of::<SoupSessionError>(),
        },
    ),
    (
        "SoupStatus",
    ...
    (
        "SoupURIComponent",
        Layout {
            size: size_of::<SoupURIComponent>(),
            alignment: align_of::<SoupURIComponent>(),
        },
    ),
    (
...
const RUST_CONSTANTS: &[(&str, &str)] = &[
    ...
    (
        "(gint) SOUP_COOKIE_JAR_ACCEPT_GRANDFATHERED_THIRD_PARTY",
        "3",
    ),
